package com.example.cursova2.menu;

import javafx.fxml.FXMLLoader;
import javafx.scene.Parent;
import javafx.scene.Scene;
import javafx.stage.Stage;
import com.example.cursova2.controller.*;

import com.example.cursova2.object.*;
...
public class TrainService{
    ...
    public void createCar(){
        ...
        createCarLoader.setLocation(getClass().getResource("/com/example/cursova2/createCar.fxml"));
        try {
    ...
    public void createTrain(){
        ...
        createTrainLoader.setLocation(getClass().getResource("/com/example/cursova2/createTrain.fxml"));
        try {
    ...
    public void deleteTrain(){
        ...
        deleteTrain.setLocation(getClass().getResource("/com/example/cursova2/delTrain.fxml"));
        try {
            deleteTrain.load();
        }catch (IOException e){
            e.printStackTrace();
    ...
    public void deleteCar(){
        ...
        deleteCarLoader.setLocation(getClass().getResource("/com/example/cursova2/delCaFromTrain.fxml"));
        try {
    ...
    public void showTrainWithNumber(){
        ...
        showTrainLoader.setLocation(getClass().getResource("/com/example/cursova2/showTrainWitnNumber.fxml"));
        try {
    ...
    public void showCarWithNumber(){
        ...
        showCarLoader.setLocation(getClass().getResource("/com/example/cursova2/showCarWithNumber.fxml"));
        try {
            showCarLoader.load();
        }catch (IOException e){
            e.printStackTrace();
    ...
    public void showTrainWythSortedCarsByComfort(){
        ...
        showTrainAndCarsLoadr.setLocation(getClass().getResource("/com/example/cursova2/showTrainWithCars.fxml"));
        try {
