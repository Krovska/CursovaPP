package com.example.cursova2.object;
...
public class Car {
    ...
    public String toString() {
        ...
        if(this.trainNumber==0)
            ...
            trainNumberStr=" Номер поїзда - "+this.trainNumber+"\n Порядковий номер вагону у поїзді - "+this.sequenceNumber+"\n Кількість пасажирів - "+this.passengersNumber;
        return this.comfortClass.toString()+"\n Кількість місць - "+ this.seatsNumber + "\n Номер вагона - " + this.carNumber+trainNumberStr;
    }
