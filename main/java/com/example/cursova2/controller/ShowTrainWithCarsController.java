...
import com.example.cursova2.object.Train;
import com.example.cursova2.sql.DatabsaseHandler;

public class ShowTrainWithCarsController {
    ...
    public void initialize() {
        ...
        showButton.setOnAction(e->{
            ...
            if(trainID!=-1) {
                ...
                String allCars="";
                Train train = databsaseHandler.getTrain(trainID);
                for(Car car: train.getCars())
                    allCars="\n"+allCars+car;
                alert.setContentText("Train "+train.getTrainNumber()+train.getDestination()+" Cars:");
                alert.showAndWait();
                myStage.close();
            }else{
